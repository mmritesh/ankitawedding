...
function setDateWithUTCtime() {
  ...
  if (args.length > 0) {
    ...
    var formattedDate = _moment2.default.utc([year, month - 1, date, hours, minutes, seconds]).format('YYYYMMDDTHHmm00') + 'Z';

    return formattedDate;
  }

  return _moment2.default.utc().format('YYYYMMDDTHHmm00') + 'Z';
}